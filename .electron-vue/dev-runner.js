...
function startRenderer() {
  return new Promise((resolve, reject) => {
    rendererConfig.entry.mainRenderer = [path.join(__dirname, 'dev-client')].concat(
      rendererConfig.entry.mainRenderer
	);
	// rendererConfig.entry.childRenderer = [path.join(__dirname, 'dev-client')].concat(
	// 	rendererConfig.entry.childRenderer
	// );
